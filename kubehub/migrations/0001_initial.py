# Generated by Django 3.0.3 on 2020-06-02 18:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('version', models.CharField(choices=[('v1.14.6', 'v1.14.6'), ('v1.15.3', 'v1.15.3'), ('v1.15.8', 'v1.15.8'), ('v1.15.11', 'v1.15.11'), ('v1.16.8', 'v1.16.8')], max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='OsImage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memory', models.IntegerField(choices=[(1, 1), (2, 2), (4, 4), (8, 8), (16, 16)])),
                ('boot_disk', models.IntegerField(choices=[(32, 32), (64, 64), (128, 128), (256, 256), (512, 512)], default=32)),
                ('node_type', models.CharField(choices=[('master', 'master'), ('worker', 'worker')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boot_disk', models.IntegerField(choices=[(32, 32), (64, 64), (128, 128), (256, 256), (512, 512)], default=32)),
                ('node_type', models.CharField(choices=[('master', 'master'), ('worker', 'worker')], max_length=255)),
                ('vbox_os_image', models.ForeignKey(default=0, on_delete=django.db.models.deletion.PROTECT, related_name='vbox_image_based_vms', to='kubehub.VirtualBoxImage')),
