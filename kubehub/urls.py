...
from .views import crud_views, k8s_cluster_view, tamplate_view, vm_group_view, kubespray_deploy_view
...
urlpatterns = [
    ...
    url(r'^cluster/create$', k8s_cluster_view.kubernetes_cluster_add, name='cluster_create'),
