"""
Django settings for kubehub_backend project.
...
# AUTH_USER_MODEL = "kubehub.KubeUser"
...
ROOT_URLCONF = 'kubehub_backend.urls'
...
AUTH_USER_MODEL = 'kubehub.Account'

WSGI_APPLICATION = 'kubehub_backend.wsgi.application'
